...
async function run() {
  ...
  await seedDocuments();
  // seedStorefront: کاتالوگِ مارکت‌پلیس/رستوران‌ها (محتوای فروشگاه). فعلاً نگه داشته شده تا
  // صفحاتِ market/dine خالی نباشند؛ اگر خواستی خالی بماند این خط را هم کامنت کن.

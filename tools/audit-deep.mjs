...
const EU = ['euHomeScreen','euAssistantScreen','euChatListScreen','euSupportScreen','euDineScreen','euMarketScreen','euCartScreen','euOffersScreen','euPlannerScreen','euProfileScreen','euReportScreen','euSearchScreen','euAgentDiscovery'];

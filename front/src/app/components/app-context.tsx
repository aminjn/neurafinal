...
export type EuScreen = 'euHomeScreen' | 'euChatListScreen' | 'euAgentDiscovery' | 'euProfileScreen' | 'euDineScreen' | 'euAssistantScreen' | 'euSupportScreen' | 'euMarketScreen' | 'euPlannerScreen' | 'euSearchScreen' | 'euReportScreen' | 'euCartScreen' | 'euOffersScreen';
